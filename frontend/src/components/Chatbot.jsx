...
const Chatbot = ({ databaseConnection, schema, selectedModel }) => {
        ...
        return (
            <div className="mt-4">
                ...
                <div className="overflow-x-auto bg-gray-50 rounded-xl border border-gray-200">
                    <table className="min-w-full text-sm">
                        <thead>
                            <tr className="bg-gray-100 border-b border-gray-200">
                                {columns.map((column) => (
                                    <th key={column} className="px-4 py-3 text-left font-medium text-gray-700">
                                        {column}
                                    </th>
                                ))}
                            </tr>
                    ...
                    {data.length > 10 && (
                        <div className="p-3 text-center text-gray-500 text-sm bg-gray-100 border-t border-gray-200">
    ...
    const renderMessage = (message) => {
        ...
        return (
            <div key={message.id} className={`flex ${isUser ? 'justify-end' : 'justify-start'} mb-6 animate-fade-in`}>
                <div className={`flex gap-3 max-w-4xl ${isUser ? 'flex-row-reverse' : 'flex-row'}`}>
                    ...
                    <div className={`rounded-xl p-4 shadow-sm ${isUser
    ...
    return (
        <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg flex flex-col h-[600px] border border-gray-200/50">
            {/* Header */}
